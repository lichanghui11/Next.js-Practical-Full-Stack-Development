...
export const RainbowButton: FC<RainbowButtonProps> = (props) => {
  ...
  return (
    <button
      type="button"
      className={cn(
        `relative inline-flex h-11 animate-rainbow cursor-pointer items-center justify-center rounded-md
                                                border-0 bg-[length:200%] px-8 py-2  font-medium text-primary-foreground transition-colors 
        ...
        `before:absolute before:bottom-[-20%] before:left-1/2 before:z-0
                                                ...
                                                before:animate-rainbow before:bg-[length:200%_100%]
