...
export const createSeedPosts = async () => {
  ...
  // 固定作者：管理员 lichanghui
  const adminUser = await prisma.user.findFirst({ where: { username: 'lichanghui' } });
  if (!adminUser) {
    throw new Error('Admin user "lichanghui" not found, please seed users first.');
  }
  ...
  const data: Item[] = [
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/1.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/2.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/3.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/4.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/5.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/6.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/7.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/8.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/9.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/ts-fullstack/10.md'),
      categoryName: 'TS全栈开发',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/creative/1.md'),
      categoryName: '码农创业记',
    ...
    },
    {
      ...
      bodyPath: path.join(__dirname, '../../../../files/fixture/creative/2.md'),
      categoryName: '码农创业记',
      tagNames: ['创业', '外包', '融资'],
    },
  ];
